...
class Products extends CI_Controller {
	...
	public function create(){
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$config['max_size']	= '3000000'; //MB
			$config['max_width']  = '30000000'; //pixels
			$config['max_height']  = '30000000'; //pixels
	...
	public function update($id){
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			if($_FILES['userfile']['name'] != ''){
				...
				$config['max_width']  = '300000'; //pixels
				$config['max_height']  = '300000'; //pixels
