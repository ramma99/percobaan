...
<html>
	<head>
		<title>Tambah Daftar Bencana</title>
			...
			<div class="col-md-10">
				...
				<?= form_open_multipart('admin/products/create', ['class'=>'form-horizontal']) ?>
					  ...
					  <div class="form-group">
						<label for="inputEmail3" class="col-sm-2 control-label">Nama Bencana</label>
						<div class="col-sm-10">
					  ...
					  <div class="form-group">
						<label for="inputPassword3" class="col-sm-2 control-label">Gambar Bnecana</label>
						<div class="col-sm-10">
